...
class Constants {
  // Constant Color
  static const Color kPinkColor = Color(0xffA020F0);
  static const Color kCyanColor = Color(0xffE6FE53);
  static const Color kGreenColor = Color(0xffE6FE53);
  ...
  static const String kIconGoogle = 'assets/svg/google-color-icon.svg';
  static const String kIconFacebook = 'assets/svg/facebook-round-color-icon.svg';
